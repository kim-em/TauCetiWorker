...
p = q._codex_from_payload({"rate_limit": {"limit_reached": False, "primary_window": win(0, WEEK, WEEK), "secondary_window": None}})
...
p = q._codex_from_payload(
    {"rate_limit": {"limit_reached": False, "primary_window": win(9, HOUR5, HOUR5 // 2), "secondary_window": win(10, WEEK, WEEK // 2)}}
)
...
p = q._codex_from_payload(
    {"rate_limit": {"limit_reached": False, "primary_window": {"limit_window_seconds": WEEK, "reset_after_seconds": WEEK // 2}, "secondary_window": None}}
)
...
p = q._codex_from_payload({"rate_limit": {"limit_reached": True, "primary_window": win(0, WEEK, WEEK), "secondary_window": None}})
